                    ...
                    <div class="form-body">
                        <div class="form-row">
                            <div class="form-controls">
                                <input type="text" class="field" name="select-uphold-card" id="select-uphold-card" value="" placeholder="Select Destination" readonly="readonly" data-toggle="modal" data-target="#card-modal" required>

                                <span class="form-field-value" id="selected-card"><strong></strong> <small class="desktop-only"></small></span>
            ...
            <div class="modal-inner">
                ...
                <div class="modal-body">
                    <ul class="list-accounts">
                        <li>
                            <a href="#" class="js-select-account" data-target="#selected-card">
                                <span>
                                    <small class="currency">GBP</small>
                                </span>

                                <strong>My Uphold Savings</strong>

                                <small><em class="currency-mark">£</em>10215.32 <em class="currency">GBP</em></small>

                                <i class="ico-star"></i>
                            </a>
                        </li>

                        <li class="list-item-favorite">
                            <a href="#" class="js-select-account" data-target="#selected-card">
                                <span>
                                    <small class="currency">GBP</small>
                                </span>

                                <strong>My GBP Card</strong>

                                <small><em class="currency-mark">£</em>652.12 <em class="currency">GBP</em></small>
                        ...
                        <li>
                            <a href="#" class="js-select-account" data-target="#selected-card">
                                ...
                                <small><em class="currency-mark">£</em>11.32 <em class="currency">GBP</em></small>

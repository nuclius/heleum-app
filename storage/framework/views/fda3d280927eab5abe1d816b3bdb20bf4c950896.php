<head>
	...
	<?php echo $__env->make('partials.global.opengraph', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<!-- App Styles -->
	<link rel="stylesheet" href="/css/style.css?v=<?php echo e(filemtime(public_path('/css/style.css'))); ?>" />
